...
person2 = ("Cande", "Agus") #ahora usamos tuplas
show(*person2)
person3 = {"last_name": "Guillén", "name": "Eduardo"} #usamos un diccionario 
show(**person3)
...
nombres = ["Carolina", "Ezequiel", "Tomas", "Rocío", "Morena", "Ceci"]
...
mi_funcion2("Cande","Roux") #argumentos
...
listar_nombres("Lucas", "Anastacia","Claudia", "Roxana", "Marta") #argumentos
listar_nombres("Mirco", "Romina", "Carolina", "Juan")
...
listarTerminos(Nombre = "Carlos Saniz jr.")

def desplegarNombres(nombres): 
    for nombre in nombres: 
        print(nombre)
nombres2 = ["Tiziano", "Pedro", "Carlos"]
desplegarNombres(nombres2)
desplegarNombres("Agustina") 
