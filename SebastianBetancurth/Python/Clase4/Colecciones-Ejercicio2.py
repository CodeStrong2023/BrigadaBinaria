...
solo1 = list(cojunto2 - cojunto1) # Solo muestra el cojunto1
solo2 = list(cojunto2 - conjunto1)# Solo muestra el cojunto2
interseccion = list(conjunto1 & conjunto2)_# Mostramos ambas listas
